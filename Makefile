...
fs.img: mkfs README testing.txt $(UPROGS)
	./mkfs fs.img README testing.txt $(UPROGS)
...
PRINT = runoff.list runoff.spec testing.txt README toc.hdr toc.ftr $(FILES)
...
EXTRA=\
	...
	printf.c umalloc.c\
	README testing.txt dot-bochsrc *.pl toc.* runoff runoff1 runoff.list\
